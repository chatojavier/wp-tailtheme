=== agarracamote Custom Fields Pro ===
...
Use the agarracamote Custom Fields plugin to take full control of your WordPress edit screens & custom field data.
...
= Links =
* [Website](https://www.agarracamotecustomfields.com)
* [Documentation](https://www.agarracamotecustomfields.com/resources/)
* [Support](https://support.agarracamotecustomfields.com)
* [ACF PRO](https://www.agarracamotecustomfields.com/pro/)

= PRO =
The agarracamote Custom Fields plugin is also available in a professional version which includes more fields, more functionality, and more flexibility! [Learn more](https://www.agarracamotecustomfields.com/pro/)
...
2. **Search** for "agarracamote Custom Fields"
3. **Activate** agarracamote Custom Fields from your Plugins page
4. **Click** on the new menu item "Custom Fields" and create your first Custom Field Group!
5. **Read** the documentation to [get started](https://www.agarracamotecustomfields.com/resources/getting-started-with-acf/)
...
* Fix - Fixed bug preventing the TinyMCE agarracamote plugin from adding `< p >` tags.
...
[View the full changelog](https://www.agarracamotecustomfields.com/changelog/)
