...
<div class="wrap acf-settings-wrap">
	...
	<div class="acf-box" id="acf-license-information">
		...
		<div class="inner">
			<p><?php printf(__('To unlock updates, please enter your license key below. If you don\'t have a licence key, please see <a href="%s" target="_blank">details & pricing</a>.','acf'), esc_url('https://www.agarracamotecustomfields.com/pro')); ?></p>
					...
					<tr>
						...
						<td>
							<?php if( $update_available ): ?>
								...
								<?php if( $active ): ?>
									<a class="button button-primary" href="<?php echo esc_attr( admin_url('plugins.php?s=agarracamote+Custom+Fields+Pro') ); ?>"><?php _e('Update Plugin', 'acf'); ?></a>
								<?php else: ?>
