<?php
/*
Plugin Name: agarracamote Custom Fields PRO
Plugin URI: https://www.agarracamotecustomfields.com
Description: Customize WordPress with powerful, professional and intuitive fields.
Version: 5.9.2
Author: Elliot Condon
Author URI: https://www.agarracamotecustomfields.com
Text Domain: acf
Domain Path: /lang
*/
...
class ACF {
	...
	function initialize() {
		...
		// Define settings.
		$this->settings = array(
			'name'						=> __('agarracamote Custom Fields', 'acf'),
