...
class ACF_Admin_Tool_Import extends ACF_Admin_Tool {
	...
	*/
	...
	function html() {
		...
		?>
		<p><?php _e('Select the agarracamote Custom Fields JSON file you would like to import. When you click the import button below, ACF will import the field groups.', 'acf'); ?></p>
